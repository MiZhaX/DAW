...
var puntos = []; // Array para almacenar las coordenadas
var map; // Variable del mapa global
...
function muestraPosicion(pos){
    ...
    var marcador = L.marker([pos.coords.latitude, pos.coords.longitude]).addTo(map);
    ...
    if(primeraIteracion){
        ...
        console.log("Has recorrido " + metrosRecorridos + " metros en total");

        var linea = L.polyline(puntos, {color: 'blue'}).addTo(map); 
    }
}
